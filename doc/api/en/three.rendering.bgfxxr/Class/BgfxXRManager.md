...
## class BgfxXRManager
```cj
public class BgfxXRManager <: EventDispatcher
```
BgfxXRManager — manages XR sessions, view matrices, and controller tracking
...
|Name|Type|Describe|
|---|---|---|
|renderer|BgfxRenderer|Bgfx renderer instance|
