...
- Reference to the current instanceCopy the settings of the given cubic Bezier curve to this instance
...
- Reference to the current instanceDeserialize the cubic Bezier curve from JSON
...
- Point on the curve (z=0)Return the point on the curve at the given interpolation factor tInterpolate x and y components using cubic Bezier basis functions respectively.
...
|v3|Vector3|End point, default zero vectorConstruct a new 2D cubic Bezier curve|
