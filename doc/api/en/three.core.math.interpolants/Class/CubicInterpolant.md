...
```
Update weights and offsets when interval changes

Parameter: 

|Name|Type|Describe|
|---|---|---|
|i1|Int64|Right keyframe indext0 Left timet1 Right time|
|t0|Float64||
|t1|Float64||
