...
"#
```
Complete content of bgfx_shader.sh, replacing runtime file lookup for #include <bgfx_shader.sh>
...
```
DFG LUT raw data (UInt16 array, 512 elements = 16x16 x 2 channels)
