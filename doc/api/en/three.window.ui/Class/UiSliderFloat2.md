# Class
## class UiSliderFloat2
```cj
public class UiSliderFloat2 <: UiWidget
```
2-channel float slider widget

### func draw\(\)
```cj
public override func draw(): Bool
```
Renders the 2-channel float slider
...
```
Constructs a 2-channel float slider widget
