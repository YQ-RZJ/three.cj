...
```
Depth of Field (DOF) post-processing pass
...
```
Aperture (larger = shallower depth of field)
...
```
Focal distance (world units, along the camera direction)

### var maxblur
```cj
public var maxblur: Float64
```
Maximum blur (caps the bokeh radius)
