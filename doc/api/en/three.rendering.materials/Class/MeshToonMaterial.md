...
```
Toon material, using gradient map to control light/dark boundaries for cartoon rendering

### func init\(\)
```cj
public init()
```
Construct a new toon material
...
```
Gradient map, controls light/dark boundaries
