...
## class BgfxRenderer
```cj
public class BgfxRenderer <: Renderer & IRenderer
```
...
|Name|Type|Describe|
|---|---|---|
|hwnd|UIntNative|Native window handlewidth Window widthheight Window height|
|width|Int32||
|height|Int32||
...
|Name|Type|Describe|
|---|---|---|
|width|Int32|Width in pixelsheight Height in pixels|
|height|Int32||
