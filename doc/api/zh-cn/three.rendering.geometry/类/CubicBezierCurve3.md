...
- 当前实例的引用将给定 3D 三次贝塞尔曲线的设置复制到此实例
...
|名称|类型|描述|
|---|---|---|
|json|HashMap<String,Any>|包含 v0、v1、v2、v3 数组的 HashMap|

返回: 

- 当前实例的引用从 JSON 反序列化 3D 三次贝塞尔曲线
...
- 曲线上的点返回曲线上给定插值因子 t 处的点用三次贝塞尔基函数分别插值 x、y、z 分量。
...
|v1|Vector3|第一个控制点，默认为空向量|
|v2|Vector3|第二个控制点，默认为空向量|
|v3|Vector3|终止点，默认为空向量构造新的 3D 三次贝塞尔曲线|
