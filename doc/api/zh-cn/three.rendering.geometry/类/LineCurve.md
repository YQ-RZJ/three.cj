...
- 直线上的点返回直线上给定插值因子 t 处的点t=1 时直接返回 v2；其他情况按 (v2-v1)*t+v1 计算。
...
|v2|Vector3|终止点，默认为空向量构造新的 2D 直线段|
