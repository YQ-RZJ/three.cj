...
"#
```
color_lighting 共享头 chunk（fs_shadowmaps_color_lighting.sh）
...
"#
```
color_lighting main 体 chunk（fs_shadowmaps_color_lighting_main.sh）
...
"#
```
color_lighting 顶点着色器 chunk（CSM 模式，InvZ）
...
"#
```
color_lighting 顶点着色器 chunk（CSM 模式，Linear）
...
"#
```
color_lighting 顶点着色器 chunk（Omni 模式）
...
"#
```
color_lighting 顶点着色器 chunk（Omni 模式，Linear）
...
"#
```
color_lighting 顶点着色器 chunk（Single 模式，InvZ）
...
"#
```
color_lighting 顶点着色器 chunk（Single 模式，Linear）
